            ...
            <div class="top_nav">
                <div class="my_box">
                    ...
                    <div class="my_intro">
                    	...
                    	<div><input name="id" type="hidden" value="<%=info.getMem_id() %>"></div>
                        <div class="my_name">닉네임<br><input type="text" class="input_name" name="nick"></div>
                        </form>
                        <div class="introduce">소개<br><textarea class="input_intro" cols="50" rows="10"></textarea></div>
                        <div class="confirm"><a href="profile.jsp"><input type="submit" class="confirm" value="수정완료" style="text-align:center;background-color:black; color:white;">
                       </a>
                        </div>
                    </div>
