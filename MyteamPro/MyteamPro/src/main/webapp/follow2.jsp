...
<head>
    ...
    <title>팔로잉 페이지</title>
    <link rel="stylesheet" href="assets/css/follow2.css">
...
<body>
    ...
    <div class="follow_container">
        <div class="top_nav">
            ...
            <div class="icon_box"><a href = "./profile.jsp"><i class="fa-solid fa-user fa-2x"></i></a> &nbsp&nbsp 
            																			 <i class="fa-solid fa-magnifying-glass fa-2x"></i></div>
        </div>

        <div class="sub_nav">
            <div class="sub_nav_item"><a href="follow2.jsp">팔로잉</a></div>
            <div class="sub_nav_item"><a href="follow1.jsp">팔로워</a></div>
        </div>
